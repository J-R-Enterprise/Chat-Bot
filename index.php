...
<head>
    <meta charset="UTF-8">
    <title>Chatbot - JR Company</title>
...
<body>
    ...
    <body>
        <header class="header">
            <div class="container header__container">
                <div class="header__logo"><img class="header__img" src="https://image.ibb.co/kcVou6/path3000.png">
                    <h1 class="header__title">Chatbot<span class="header__light">.io</span></h1>
                </div>
                ...
                <div class="header__menu">
                    <nav id="navbar" class="header__nav collapse">
                        <ul class="header__elenco">
                            ...
                            <li class="header__el"><a href="#" class="header__link">Caracteristicas</a></li>
                            <li class="header__el"><a href="#historias" class="header__link">Historias</a></li>
                            <li class="header__el"><a href="#" class="header__link"><b>JR Company</b></a></li>
        ...
        <div class="sect sect--padding-top">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="site">
                            <h1 class="site__title">Hey! Necesitas hablar?</h1>
                            <h2 class="site__subtitle">Habla con Migo, Puedo ayudarte</h2>
                            <div class="site__box-link">
                                <a class="btn btn--width" href="">Chatiemos</a>
                                <a class="btn btn--revert btn--width" href="">¿Que eres?</a>
                            </div>
        ...
        <div class="sect sect--padding-bottom">
            <div class="container">
                <div class="row row--center">
                    ...
                    <h2 class="row__sub">Conoce mas sobre mi funcionamiento...</h2>
                </div>
                    ...
                    <div class="col-md-4 col-sm-4 price-box price-box--purple">
                        <div class="price-box__wrap">
                            ...
                            <p class="price-box__feat">
                                Para q tengas en cuenta
                            </p>
                            <ul class="price-box__list">
                                <li class="price-box__list-el">No estoy capacitada para atender situaciones de crisis</li>
                                <li class="price-box__list-el">Atiendo, Analizo y Perfecciono</li>
                                <li class="price-box__list-el">No soy Profesional para darte un diagnostico psicologico</li>
                                <li class="price-box__list-el">No remplazo la terapia profesional</li>
                                <li class="price-box__list-el">Nuestras conversaciones son Ultrasecretas</li>
                            </ul>
                    ...
                    <div class="col-md-4 col-sm-4 price-box price-box--blue">
                        <div class="price-box__wrap">
                            ...
                            <h2 class="price-box__discount">
                                <span class="price-box__dollar">$</span>399<span
                                    class="price-box__discount--light">/mo</span>
                            </h2>
        ...
        <div class="sect sect--white" id="historias">
            <div class="container">
                <div class="row">
                    <h1 class="row__title">
